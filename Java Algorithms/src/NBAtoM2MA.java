...
public class NBAtoM2MA {
	...
	public static void main(String[] args) throws Exception {
		...
		run(20, 5, 10, 2, true, true);
		run(20, 5, 15, 2, true, true);
		run(20, 5, 20, 2, true, true);
		run(20, 5, 25, 2, true, true);
		run(20, 5, 30, 2, true, true);
		
		System.out.println("10% complete");
		
		run(20, 5, 10, 3, true, true);
		run(20, 5, 15, 3, true, true);
		run(20, 5, 20, 3, true, true);
		run(20, 5, 25, 3, true, true);
		run(20, 5, 30, 3, true, true);
		
		System.out.println("20% complete");
		
		run(20, 10, 20, 3, true, true);
		run(20, 10, 25, 3, true, true);
		run(20, 10, 30, 3, true, true);
		run(20, 10, 35, 3, true, true);
		run(20, 10, 40, 3, true, true);
		run(20, 10, 45, 3, true, true);
		run(20, 10, 50, 3, true, true);
		
		System.out.println("34% complete");
		
		run(20, 10, 20, 4, true, true);
		run(20, 10, 25, 4, true, true);
		run(20, 10, 30, 4, true, true);
		run(20, 10, 35, 4, true, true);
		run(20, 10, 40, 4, true, true);
		run(20, 10, 45, 4, true, true);
		run(20, 10, 50, 4, true, true);
		
		System.out.println("48% complete");
		
		run(20, 15, 30, 4, true, true);
		run(20, 15, 40, 4, true, true);
		run(20, 15, 50, 4, true, true);
		run(20, 15, 60, 4, true, true);
		run(20, 15, 70, 4, true, true);
		run(20, 15, 80, 4, true, true);
		
		System.out.println("60% complete");
		
		run(20, 15, 30, 5, true, true);
		run(20, 15, 40, 5, true, true);
		run(20, 15, 50, 5, true, true);
		run(20, 15, 60, 5, true, true);
		run(20, 15, 70, 5, true, true);
		run(20, 15, 80, 5, true, true);
		
		System.out.println("72% complete");
		
		run(20, 20, 40, 5, true, true);
		run(20, 20, 50, 5, true, true);
		run(20, 20, 60, 5, true, true);
		run(20, 20, 70, 5, true, true);
		run(20, 20, 80, 5, true, true);
		run(20, 20, 90, 5, true, true);
		run(20, 20, 100, 5, true, true);
		
		System.out.println("86% complete");
		
		run(20, 20, 40, 6, true, true);
		run(20, 20, 50, 6, true, true);
		run(20, 20, 60, 6, true, true);
		run(20, 20, 70, 6, true, true);
		run(20, 20, 80, 6, true, true);
		run(20, 20, 90, 6, true, true);
		run(20, 20, 100, 6, true, true);
	...
	public static void run(int numTimes, int numStates, int numTransitions, int numFinalStates, boolean inNBA, boolean inM2MA) throws Exception {
		...
		for (int i = 0; i < numTimes; i++) {
			...
			if (inNBA) {
				...
				DBAtoM2MA.DBAtransitions(numStates, numTransitions, tempTransitions, reverseTempTransitions);
			}
